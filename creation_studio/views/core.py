...
# =============================================================================
# MODO TEST / DEVELOPMENT BYPASS
# Comenta este bloque si quieres volver a usar tokens reales
# =============================================================================
from rest_framework.permissions import AllowAny as IsAuthenticated
class MockAuth:
    def authenticate(self, request):
        from ..auth.backends import SIAUser
        # Creamos un usuario de servicio que tiene acceso a todo
        return (SIAUser(user_id='service', email='test@example.com', role='service'), 'mock-token')
    def authenticate_header(self, request): return 'Bearer'
SIAJWTAuthentication = MockAuth
SIAAPIKeyAuthentication = MockAuth
# =============================================================================
...
def check_ownership(obj, user):
    return True # MODO TEST: Desactivar validación de dueño para pruebas
