...
if __name__ == "__main__":
    # Example usage
    service = TemplateEmbeddingService()
    
    # Test single embedding
    test_text = "A professional Instagram post template with modern design and blue color scheme"
    ...
    test_texts = [
        ...
        "Bold colors for tech product launch",
        "Elegant fashion template with soft pink tones"
    ]
